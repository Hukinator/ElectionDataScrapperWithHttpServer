...
public class UserDemo {
    ...
    public static void main(String args[]) throws IOException, URISyntaxException {
        String bearerToken = ("AAAAAAAAAAAAAAAAAAAAAL99kAEAAAAAQHTx21UWE3qMSeRP7wRca4Ztxmo%3DwzzscCFK0o8aZkr3KQFxx2zCQ2t0vg7L1dDBbxJcVKBnTt0vbR");
        if (null != bearerToken) {
            //Replace comma separated usernames with usernames of your choice
            String response = getUsers("NDRnds", bearerToken);
